...
<div class="content-wrapper">
  ...
  <section class="content">
    <form action="/admin/products" method="POST" role="form" enctype="multipart/form-data">
      {{ csrf_field() }}
      <div class="container-fluid">
        <div class="row">
          <div class="col-9">
                          ...
                          <div class="tab-content" id="vert-tabs-tabContent">
                            <div class="tab-pane text-left fade active show" id="vert-tabs-general" role="tabpanel" aria-labelledby="vert-tabs-general-tab">
                              <div class="form-group">
                                ...
                                <input name="regular_price" type="text" class="form-control" placeholder="">
                              </div>
                              <div class="form-group">
                                <label>Sale Price</label>
                                <input name="sale_price" type="text" class="form-control" placeholder="">
                              </div>
                            </div>
            ...
            <div class="card">
              ...
              <!-- form start -->
                ...
                <div class="card-footer">
                  <button name="productstatus" type="submit" class="btn btn-primary">Publish</button>
                </div>
            </div>
            <div class="card">
              <div class="card-header">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-control custom-checkbox">
                      <input class="custom-control-input" name="category_id" type="checkbox" id="catCheckbox{{$category->id}}" value="{{$category->id}}">
                      <label for="catCheckbox{{$category->id}}" class="custom-control-label">{{$category->name}}</label>
                    </div>
                    @endforeach
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-control custom-checkbox">
                      <input class="custom-control-input" name="brand_id" type="checkbox" id="brandCheckbox{{$brand->id}}" value="{{$brand->id}}">
                      <label for="brandCheckbox{{$brand->id}}" class="custom-control-label">{{$brand->name}}</label>
                    </div>
                    @endforeach
                  </div>
              </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-control custom-checkbox">
                      <input class="custom-control-input" name="tag_id" type="checkbox" id="tagCheckbox{{$tag->id}}" value="{{$tag->id}}">
                      <label for="tagCheckbox{{$tag->id}}" class="custom-control-label">{{$tag->name}}</label>
                    </div>
                    @endforeach
                  </div>
              </div>
